            ...
            <div>
                <div className="nes-container is-rounded text">
                    ...
                    <p>Sou uma pessoa curiosa e apaixonada por tecnologia e como podem ver por animes tambem , nunca estou satisfeito com conhecimento
                       que tenho e sempre busco aprender mais sendo por video aulas, cursos onlines, livros e resolvendo os problemas
                       do dia a dia.
                    </p>

                    <p>Atualmente trabalhando com as .NET CORE e vue, tambem estou trabalhando em um projeto pessoal
                       que seria um app que esta sendo desenvolvido em React native para auxiliar em jogos de RPG de mesa, tendo como foco o armazenamento de informações
